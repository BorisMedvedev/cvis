document.addEventListener('DOMContentLoaded', function () {
  ...
  function validateWeightHeightInputs() {
    ...
    nextButtons[currentQuestionIndex + 1].disabled = !(weightInput.value && heightInput.value);
  }
  ...
  function calculateBMI() {
    if (weight > 0 && height > 0) {
      ...
      if (bmi < 16) {
        ...
        description = 'Надо начать с корректировки питания и т.д.';
        markerPosition = 5;
      } else if (bmi >= 16 && bmi < 18.5) {
        category = 'Недостаточная масса тела.';
        description = 'Важно наладить питание ...';
        markerPosition = 20;
      } else if (bmi >= 18.5 && bmi < 25) {
        category = 'Нормальная масса тела.';
        description = 'Тебе подходит сбалансированное питание ...';
        markerPosition = 50;
      } else if (bmi >= 25 && bmi < 30) {
        category = 'Предожирение.';
        description = 'Пересмотри питание ...';
        markerPosition = 75;
      } else if (bmi >= 30 && bmi < 35) {
        category = 'Ожирение 1-й степени.';
        description = 'Скорректируй питание ...';
        markerPosition = 90;
      } else if (bmi >= 35 && bmi < 40) {
        category = 'Ожирение 2-й степени.';
        description = 'Снижай калорийность ...';
        markerPosition = 95;
      } else if (bmi >= 40) {
        category = 'Ожирение 3-й степени.';
        description = 'Нужно серьезно пересмотреть рацион ...';
        markerPosition = 99;
      } else {
